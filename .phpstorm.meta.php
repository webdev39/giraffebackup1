...
namespace PHPSTORM_META {
    ...
    * Generated on 2019-02-26 14:12:09.
    *
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
        'ActionRepo' => \App\Repositories\ActionRepositoryEloquent::class,
        'ActionSer' => \App\Services\Action\ActionService::class,
        'ActivityLogRepo' => \App\Repositories\ActivityLogRepositoryEloquent::class,
        'ActivityLogSer' => \App\Services\ActivityLog\ActivityLogService::class,
        'AttachmentCommentRepo' => \App\Repositories\AttachmentCommentRepositoryEloquent::class,
        'AttachmentRepo' => \App\Repositories\AttachmentRepositoryEloquent::class,
        'AuthSer' => \App\Services\AuthService::class,
        'BillPdfSer' => \App\Services\Bill\Pdf\BillPdfService::class,
        'BillRepo' => \App\Repositories\BillRepositoryEloquent::class,
        'BillSer' => \App\Services\Bill\BillService::class,
        'BillTimerRepo' => \App\Repositories\BillTimerRepositoryEloquent::class,
        'BillingSer' => \App\Services\Billing\BillingService::class,
        'BillingStatusRepo' => \App\Repositories\BillingStatusRepositoryEloquent::class,
        'BoardPriorityRepo' => \App\Repositories\BoardPriorityRepositoryEloquent::class,
        'BoardRepo' => \App\Repositories\BoardRepositoryEloquent::class,
        'BoardSer' => \App\Services\Board\BoardService::class,
        'BoardTaskRepo' => \App\Repositories\BoardTaskRepositoryEloquent::class,
        'BudgetRepo' => \App\Repositories\BudgetRepositoryEloquent::class,
        'BudgetSer' => \App\Services\Budget\BudgetService::class,
        'BudgetTypeRepo' => \App\Repositories\BudgetTypeRepositoryEloquent::class,
        'CommentAttachmentRepo' => \App\Repositories\CommentAttachmentRepositoryEloquent::class,
        'CommentRepo' => \App\Repositories\CommentRepositoryEloquent::class,
        'CommentSer' => \App\Services\Comment\CommentService::class,
        'CustomerRepo' => \App\Repositories\CustomerRepositoryEloquent::class,
        'CustomerSer' => \App\Services\Customer\CustomerService::class,
        'FieldRepo' => \App\Repositories\FieldRepositoryEloquent::class,
        'FilterRepo' => \App\Repositories\FilterRepositoryEloquent::class,
        'FilterSer' => \App\Services\Filter\FilterService::class,
        'GroupRepo' => \App\Repositories\GroupRepositoryEloquent::class,
        'GroupSer' => \App\Services\Group\GroupService::class,
        ...
        'ImageRepo' => \App\Repositories\ImageRepositoryEloquent::class,
        'ImageSer' => \App\Services\Image\ImageService::class,
        'Laravel\Scout\EngineManager' => \Laravel\Scout\EngineManager::class,
        'LogAttachmentRepo' => \App\Repositories\LogAttachmentRepositoryEloquent::class,
        'LogRepo' => \App\Repositories\LogRepositoryEloquent::class,
        'NotificationSer' => \App\Services\Notification\NotificationService::class,
        'NotificationSubscriptionRepo' => \App\Repositories\NotificationSubscriptionRepositoryEloquent::class,
        'PauseRepo' => \App\Repositories\PauseRepositoryEloquent::class,
        'PermissionRepo' => \App\Repositories\PermissionRepositoryEloquent::class,
        'PermissionSer' => \App\Services\Permission\PermissionService::class,
        'PersonalDeadlineRepo' => \App\Repositories\PersonalDeadlineRepositoryEloquent::class,
        'PipelineFilterRepo' => \App\Repositories\PipelineFilterRepositoryEloquent::class,
        'PipelineRepo' => \App\Repositories\PipelineRepositoryEloquent::class,
        'PipelineRuleRepo' => \App\Repositories\PipelineRuleRepositoryEloquent::class,
        'PipelineSer' => \App\Services\Pipeline\PipelineService::class,
        'PriorityRepo' => \App\Repositories\PriorityRepositoryEloquent::class,
        'PrioritySer' => \App\Services\Priority\PriorityService::class,
        'RepeatRepo' => \App\Repositories\RepeatRepositoryEloquent::class,
        'RepeatSer' => \App\Services\Repeat\RepeatService::class,
        'ReportsSer' => \App\Services\Reports\ReportsService::class,
        'RoleRepo' => \App\Repositories\RoleRepositoryEloquent::class,
        'RoleSer' => \App\Services\Role\RoleService::class,
        ...
        'SubTaskRepo' => \App\Repositories\SubTaskRepositoryEloquent::class,
        'SubscriptionRepo' => \App\Repositories\SubscriptionRepositoryEloquent::class,
        'TaskRepo' => \App\Repositories\TaskRepositoryEloquent::class,
        'TaskSer' => \App\Services\Task\TaskService::class,
        'TaskSortOrderRepo' => \App\Repositories\TaskSortOrderRepositoryEloquent::class,
        'TaskSortOrderSer' => \App\Services\TaskSortOrder\TaskSortOrderService::class,
        'TenantCustomRoleRepo' => \App\Repositories\TenantCustomRoleRepositoryEloquent::class,
        'TenantRepo' => \App\Repositories\TenantRepositoryEloquent::class,
        'TenantSer' => \App\Services\Tenant\TenantService::class,
        'TimeSer' => \App\Services\Time\TimeService::class,
        'TimerBillingRepo' => \App\Repositories\TimerBillingRepositoryEloquent::class,
        'TimerLogRepo' => \App\Repositories\TimerLogRepositoryEloquent::class,
        'TimerLogSer' => \App\Services\Log\TimerLogService::class,
        'TimerRepo' => \App\Repositories\TimerRepositoryEloquent::class,
        'TimerSer' => \App\Services\Timer\TimerService::class,
        ...
        'UserProfileRepo' => \App\Repositories\UserProfileRepositoryEloquent::class,
        'UserProfileSer' => \App\Services\UserProfile\UserProfileService::class,
        'UserRepo' => \App\Repositories\UserRepositoryEloquent::class,
        'UserSer' => \App\Services\User\UserService::class,
        'UserTaskRepo' => \App\Repositories\UserTaskRepositoryEloquent::class,
        'UserTaskSer' => \App\Services\UserTask\UserTaskService::class,
        'UserTenantGroupRepo' => \App\Repositories\UserTenantGroupRepositoryEloquent::class,
        'UserTenantPriorityRepo' => \App\Repositories\UserTenantPriorityRepositoryEloquent::class,
        'UserTenantRepo' => \App\Repositories\UserTenantRepositoryEloquent::class,
        'UserTenantRoleRepo' => \App\Repositories\UserTenantRoleRepositoryEloquent::class,
        'UserTenantSettingsRepo' => \App\Repositories\UserTenantSettingsRepositoryEloquent::class,
        'UserTenantTaskRepo' => \App\Repositories\UserTenantTaskRepositoryEloquent::class,
        'UserTenantTemplatesRepo' => \App\Repositories\UserTenantTemplatesRepositoryEloquent::class,
        'Webklex\IMAP\Client' => \Webklex\IMAP\Client::class,
        'Webklex\IMAP\ClientManager' => \Webklex\IMAP\ClientManager::class,
        'auth' => \App\Services\CustomAuth\CustomAuthManager::class,
        'auth.driver' => \App\Services\CustomAuth\CustomSessionGuard::class,
        ...
        'entrust' => \App\Services\CustomEntrust::class,
